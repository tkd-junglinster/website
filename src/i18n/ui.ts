...
export const ui = {
  fr: {
    ...
    'event.status.save-the-date': 'Réservez la date',
    'event.status.provisional': 'Provisoire',
    'event.status.confirmed': 'Confirmé',
    'event.status.registration-open': 'Inscriptions ouvertes',
  ...
  en: {
    ...
    'event.status.provisional': 'Provisional',
  ...
  de: {
    ...
    'event.status.save-the-date': 'Termin vormerken',
    'event.status.provisional': 'Vorläufig',
    'event.status.confirmed': 'Bestätigt',
    'event.status.registration-open': 'Anmeldung offen',
